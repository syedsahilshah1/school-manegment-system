...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">DSCHOOL MANAGEMENT</a>
...
if (mysqli_num_rows($result) > 0) {
    ...
    if ($row2["request"] == "") {
        ...
        <i class="fas fa-book me-2"></i> Book Bus Service
      </button>';
...
<script type="text/javascript">
  document.getElementById("request").addEventListener("click", function(event) {
    var result = window.confirm("Do you really want to book the bus service?");
    if (result) {
